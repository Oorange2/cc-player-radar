-- Billboard auto-updater & launcher
local URL  = "https://raw.githubusercontent.com/Oorange2/cc-player-radar/main/billboard.lua"
local FILE = "billboard.lua"
...
if ok and res then
    ...
    if remote ~= readLocal() then
        ...
        print("Billboard updated! Rebooting...") sleep(1) os.reboot()
    end
else

...
local SOURCES = {
    { vault="create:item_vault_9",  buffer="minecraft:barrel_7",  packager="Create_Packager_2" },
    { vault="create:item_vault_10", buffer="minecraft:barrel_8",  packager="Create_Packager_0" },
    { vault="create:item_vault_11", buffer="minecraft:barrel_9",  packager="Create_Packager_1" },
